...
if(!Boolean(process.argv[2])){
	//console.log())
	selectedNetwork = networkConfig.fantomTestnet
}else{

	selectedNetwork = networkConfig[process.argv[2]];
}
...
myContractInstance = new web3.eth.Contract(
	MY_CONTRACT_ABI,
	MY_CONTRACT_ADDRESS
);
myContractClientInstance = new web3.eth.Contract(
	MY_CONTRACT_CLIENT_ABI,
	MY_CONTRACT_CLIENT_ADDRESS
);
